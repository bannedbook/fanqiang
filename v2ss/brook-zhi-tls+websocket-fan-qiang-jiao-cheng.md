...
_**如果更改域名的DNS配置或其它内容，或者是更换域名，可能必须\# rm -rf .letsencrypt ，并重新启动brook wsserver 。**_

**第五步：Brook客户端使用方法**

本文主要以Windows客户端为例，介绍Windows版Brook客户端的安装配置 到这里

[https://github.com/txthinking/brook/releases](https://github.com/txthinking/brook/releases)

下载适合你最新的版本，当前是

[https://github.com/txthinking/brook/releases/download/v20200201/brook\_windows\_386.exe](https://github.com/txthinking/brook/releases/download/v20200201/brook_windows_386.exe)
