...
> 
> 1.  [ChromeGoMac下载点](https://d1a.wenxin-ai.top/ChromeGoMac.zip)
> 2.  [ChromeGoMac下载点](https://d1.wenxin-ai.top/ChromeGoMac.zip)
> 3.  [ChromeGoMac下载点](https://d2.wenxin-ai.top/ChromeGoMac.zip)
> 4.  [ChromeGoMac下载点](https://github.com/bannedbook/fanqiang/releases)

### 使用说明

1.下载后,比如下载到了下载文件夹,解压到当前目录

2.打开终端,输入下面的命令进入程序文件夹
