...
*   **2022年10月16日更新公告：更新ip，若干程序更新。 win10系统的防火墙可能会起网络阻碍作用，如果多款工具更新ip后无法正常使用，可以把防火墙和杀毒软件关闭再试试看。**  使用方法：下载后解压，按文件夹里面的《使用说明（必看）》操作。第一次使用或不好用的时候记得按照使用说明更新一下ip。
...
> 
> 1.  [ChromeGo下载点](https://d1a.v2rss.gq/ChromeGo.7z)
> 2.  [ChromeGo下载点](https://d1.v2rss.gq/ChromeGo.7z)
> 3.  [ChromeGo下载点](https://d2.v2rss.gq/ChromeGo.7z)
