...
cd /d %~dp0
..\..\wget --no-check-certificate https://cdn.jsdelivr.net/gh/Alvin9999/pac2@latest/trojan-go/config.json
...
ECHO.&ECHO.已更新完成最新可用trojan-go配置,请按回车键或空格键启动程序！ &PAUSE >NUL 2>NUL
exit